...
Promise.all = function (iterable) {
  ...
  return new Promise((resolve, reject) => {
    const curryAllresolve = curry(function interableResolve(iterableLength, doneCount, iterableResult, resolve, index) {
      return (indexValue) => {
    ...
    const indexResolve = curryAllresolve(iterable.length - 1, 0, [], resolve);
